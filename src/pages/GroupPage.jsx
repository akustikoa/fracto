          ...
          <BalanceList
            ...
            footerAction={
              <button
                ...
                className='flex items-center justify-center gap-3 h-12 w-full rounded-2xl bg-zinc-900 text-sm font-medium text-white transition shadow-md hover:bg-zinc-100 hover:text-zinc-700'
              >
